...
public class PITCHER {
    ...
    public void run(UnitController uc1) {
        ...
        int lst = -1;
        uc = uc1;
        int id = uc.read(2); uc.write(2, id + 1);
        all_directions = Direction.values();
        rand_dir = all_directions[uc.read(10 + id % 8)];
        ...
        while(true){
            ...
            if(current_objective == -1 || uc.read(current_objective + 2) != 0){
